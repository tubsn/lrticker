...
<aside class="fav-area">
	...
	<p><small>
		<a href="http://www.fcenergie.de" target="_blank">www.fcenergie.de</a><br />
	...
	<img class="ball" src="/styles/img/ticker-icons/rot.png">
	<img class="ball" src="/styles/img/ticker-icons/gelb.png">
	...
	<a class="button block" href="{{ $ticker->id }}/preview/" target="_blank">Preview</a>
</aside>
